...
PRE_BUILD_CMDS='sed -i "s/cmake /cmake -DCMAKE_POLICY_VERSION_MINIMUM=3.5 -DCEGUI_BUILD_RENDERER_DIRECT3D11=FALSE -DCEGUI_BUILD_RENDERER_OPENGL=FALSE -DCEGUI_BUILD_RENDERER_OPENGLES=FALSE -DCEGUI_BUILD_RENDERER_OPENGL3=FALSE -DCEGUI_BUILD_IMAGECODEC_FREEIMAGE=FALSE -DCEGUI_OPTION_DEFAULT_IMAGECODEC=OgreRenderer-0 -DCEGUI_BUILD_STATIC_CONFIGURATION=OFF -DCMAKE_CXX_FLAGS=-std=c++11 /" ./PKGBUILD' make-aur-package cegui-git
